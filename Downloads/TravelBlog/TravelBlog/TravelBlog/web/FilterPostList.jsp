...
<html>
    ...
    <body>
        ...
        <div>
            <a href="PostList" class="link-primary" style="font-size: 20px;"><strong>< Back to home</strong></a>
        </div>
        <div class="container">
            ...
            <div class="col-md-12 col-lg-12">
                ...
                <c:if test="${sessionScope.posts==null||sessionScope.posts.size()==0}">
                    <h1>NOT FOUND</h1>
                </c:if>
                <c:forEach items="${sessionScope.posts}" var="p">
